...
sudo apt install curl git wget build-essential -y >/dev/null 2>&1
...
echo ""
running_text "WARNING: " "$RED"
running_text "Before proceeding, please ensure that you are prepared to become a validator, You need to set up your node data and be ready to join the DaVinci Protocol."

echo ""
read -p "Are you willing to be a validator? (yes/no): " answer
...
echo ""
running_text "Calling Complete, Get Ready to be a part of DaVinci Node Earners..."